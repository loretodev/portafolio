...
<div class="container">
    ...
    <h2 class="text-center my-5"><u>Ingresar Experiencia</u></h2>
    <form action="../../ExperienciaAdmin?accion=insSub" method="post" name="frm" id="frm">
		  ...
		  <tbody>
		    <tr>
		      <td>Titulo:</td>
                    ...
                    <tr>
		      <td>Texto:</td>
		      <td><input type="text" class="form-control" id="texto" name="texto" ></td>
                      <td colspan="2"></td>
		    </tr>
		    <tr>
		      <td>Página:</td>
		      <td><input type="text" class="form-control" id="pagina" name="pagina" ></td>
                      <td colspan="2"></td>
		    </tr>
		  </tbody>
		</table>        
