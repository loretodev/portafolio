...
<div class="container">
    ...
    <h2 class="text-center my-5"><u>Ingresar Portafolio</u></h2>
    <form action="../../PortafolioAdmin?accion=insSub" method="post" name="frm" id="frm">
		<table class="table">
		  <tbody>
		    <tr>
		      <td>Nombre:</td>
		      ...
		      <td>Apellido:</td>
		      <td><input type="text" class="form-control" id="apellido" name="apellido" ></td>                      
		    </tr>
		    <tr>
		      <td>Dirección:</td>
		      <td><input type="text" class="form-control" id="direccion" name="direccion" ></td>
                      <td colspan="2"></td>
		    </tr>
                    <tr>
		      <td>Profesion:</td>
		      <td><input type="text" class="form-control" id="profesion" name="profesion" ></td>
                      <td colspan="2"></td>
		    </tr>
		    <tr>
		      <td>Texto "acerca de mi" izquierda:</td>
		      <td><textarea name="acercaDeMi01" rows="10" cols="20" class="form-control"></textarea></td>
                      <td>Texto "acerca de mi" derecha:</td>
		      <td>
                          <textarea name="acercaDeMi02" rows="10" cols="20" class="form-control"></textarea>
                      </td>
		    </tr>
